...
impl PolicyConfig {
    ...
    pub fn set_default_endpoint(&self, device_id: &str) -> WasapiRes<()> {
        ...
        unsafe {
            ...
            if hr.0 != 0 {
                return Err(Box::try_from(WasapiError::new(&*format!("Error with 0x{:X}", hr.0))).unwrap());
            }
